  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 font-serif">
            How We're Different
          </h2>
        ...
        >
                ...
                {jCurveFeatures.map((feature, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-base sm:text-lg font-semibold text-white group-hover/item:text-green-400 transition-colors duration-300">
                        {feature.title}
                      </h4>
                      <p className="text-gray-400 text-xs sm:text-sm mt-1 group-hover/item:text-gray-300 transition-colors duration-300">
                        {feature.description}
                      </p>
                    </div>
                  </motion.div>
          ...
          {/* VS Divider (Mobile) */}
          <div className="lg:hidden flex items-center justify-center py-6 sm:py-8">
            <motion.div
              animate={{ scale: [1, 1.1, 1] }}
              transition={{ duration: 2, repeat: Infinity }}
              className="text-2xl sm:text-4xl font-bold text-gray-500 bg-gray-800/50 rounded-full w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center border border-gray-600"
            >
              VS
            </motion.div>
          </div>
              ...
              <div className="space-y-6">
                {agencyFlaws.map((flaw, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-base sm:text-lg font-semibold text-white group-hover/item:text-red-400 transition-colors duration-300">
                        {flaw.title}
                      </h4>
                      <p className="text-gray-400 text-xs sm:text-sm mt-1 group-hover/item:text-gray-300 transition-colors duration-300">
                        {flaw.description}
        ...
        >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-block px-4 sm:px-8 py-3 sm:py-4 text-sm sm:text-base bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-full hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300"
          >
            Get Started Today
          </motion.a>
        </motion.div>
